...
import { postManagerRequest, clearErrors } from '../../Actions/Entity/managerActions';
import { getAllTeamsRequest } from '../../Actions/Team/teamActions';
import { MANAGER_ADD_RESET } from '../../Constants/Entity/managerConstants';

const NewManager = ({ history }) => {
    ...
    const { loading, error, success } = useSelector(state => state.newManager);
    const { teams } = useSelector(state => state.teams);

    useEffect(() => {
        getAllTeamsRequest();
        setEmployeeNumber(uuidv4());
        setContactId(uuidv4());
        ...
        if(success) {
            history.push('/users');
            alert.success('Manager created successfully');
            dispatch({ type: MANAGER_ADD_RESET });
        }
    ...
    const submitHandler = (e) => {
        ...
        dispatch(postManagerRequest(false, manager))
    }

    return (
        <Fragment>
            <MetaData title={'New Manager'} />
            <div className="row">
                    ...
                    <Fragment>
                        <div className="wrapper my-5">
                            <form className="shadow-lg" onSubmit={submitHandler}>
                                <h1 className="mb-4">Add Manager</h1>
