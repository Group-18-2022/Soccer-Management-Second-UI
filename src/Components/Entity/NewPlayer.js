...
import { postPlayerRequest, clearErrors } from '../../Actions/Entity/playerActions';
import { getAllTeamsRequest } from '../../Actions/Team/teamActions';
import { PLAYER_ADD_RESET } from '../../Constants/Entity/playerConstants';
...
const NewPlayer = ({ history }) => {
    ...
    const { loading, error, success } = useSelector(state => state.newPlayer);
    ...
    useEffect(() => {
        ...
        if(success) {
            history.push('/users');
            alert.success('Player created successfully');
            dispatch({ type: PLAYER_ADD_RESET });
        }
    ...
    const submitHandler = (e) => {
        ...
        dispatch(postPlayerRequest(false, player))
    }

    return (
        <Fragment>
            <MetaData title={'New Player'} />
            <div className="row">
                    ...
                    <Fragment>
                        <div className="wrapper my-5">
                            <form className="shadow-lg" onSubmit={submitHandler}>
                                <h1 className="mb-4">Add Player</h1>
