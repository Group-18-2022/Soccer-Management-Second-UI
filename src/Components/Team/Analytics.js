...
//       let numberOfTrphiesWonPerMonth = 0;

//         teamStatistics && teamStatistics.map((s) => {
//           let dateOfTrphiesWon = new Date();
          
//           if(date.getMonth() + 1 === dateOfTrphiesWon.getMonth() + 1 && dateOfTrphiesWon.getMonth() + 1 === dateMonth) {
//             numberOfTrphiesWonPerMonth = numberOfTrphiesWonPerMonth + 1;
//           }
//         });

//         if(new Date().getDay() + 1 === 28) {
//           totalTrophiesPerMonth.push({ 
//             dateMonth: dateMonth,
//             payments: numberOfTrphiesWonPerMonth
//           })
//         }
//       return numberOfTrphiesWonPerMonth;
//     };
